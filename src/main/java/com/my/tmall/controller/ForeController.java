...
import com.my.tmall.comparator.*;
import com.my.tmall.pojo.*;
...
public class ForeController {
        ...
        if (null!=sort){
            switch (sort){
                ...
                case "saleCount":
                    ...
                    break;
                case "price":
                    Collections.sort(category.getProducts(),new ProductPriceConparator());
                    break;
                case "all":
    ...
    public String buy(Model model,String[] oiid,HttpSession session){
        ...
        for (String stird:oiid){
            int id= Integer.parseInt(stird);
    ...
    public String doreview(Model model,@RequestParam("oid") int oid,@RequestParam("pid") int pid, HttpSession session,String content){
        Order o=orderService.get(oid);
